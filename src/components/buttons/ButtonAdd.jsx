    ...
    return (
        <div className="relative h-20">
            <button onClick={onClick}
             ...
             focus:outline-none hover:border-gray-500 flex items-center text-baseGray hover:text-gray-500
             space-x-2 shadow-2xl border border-gray-150 hover:scale-105 transform transition-transform duration-300 ease-in-out">
                ...
                <img className="rounded-full object-cover" width={20} height={40} src="./images/add-button.png" alt="Agregar" />
            </button>
        </div>
    )
}
